...
@pytest.mark.parametrize("apac, emea, us_east, us_west",
 [
     ...
     pytest.param('FOR - Fortaleza', 'JNB - Johannesburg, South Africa - PCI', 'AGC - Atlanta - PCI', 'LAA - Los Angeles', id="variant 5"),
     ...
     pytest.param('OSA - Osaka - PCI', 'MIL - Milan', 'MID - Miami - PCI', 'Bypass', id="variant 10"),
